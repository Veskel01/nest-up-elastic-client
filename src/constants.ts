export const CLASS_METHOD_NAME = 'forRoot';
export const CLASS_ASYNC_METHOD_NAME = `${CLASS_METHOD_NAME}Async`;
export const FACTORY_METHOD_NAME = 'createElasticsearchModuleOptions';
